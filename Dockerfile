...
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)" \
  ...
  && curl -fsSLO --http1.1 --compressed "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz" \
  && curl -fsSLO --http1.1 --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc" \
...
RUN set -ex \
  ...
  && curl -fsSLO --http1.1 --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz" \
  && curl -fsSLO --http1.1 --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc" \
